...
class teacherVersion extends StatefulWidget {
  const teacherVersion({super.key});

  @override
  State<teacherVersion> createState() => _teacherVersionState();
}

class _teacherVersionState extends State<teacherVersion> {
  @override
