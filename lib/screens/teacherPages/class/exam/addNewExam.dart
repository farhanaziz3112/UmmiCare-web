                                      ...
                                      children: <Widget>[
                                        ...
                                        TextFormField(
                                          ...
                                          decoration: textInputDecoration
                                              .copyWith(hintText: 'Exam Title'),
                                          validator: (value) => value == ''
                                              ? 'Please enter exam title'
                                              : null,
                                          onChanged: (value) =>
                                              setState(() => examTitle = value),
                                        ),
                                        const SizedBox(
                                          height: 40.0,
                                        ),
                                                  ...
                                                  onPressed: () async {
                                                    if (_formKey.currentState!
                                                      ...
                                                      for (int i = 0;
                                                          ...
                                                          i++) {
                                                        scheduleDatabase()
                                                            .createAcademicCalendarScheduleData(
                                                                '${subjectList[i].subjectName} (${examTitle})',
                                                                examStartDate.millisecondsSinceEpoch.toString(),
                                                                examStartDate.millisecondsSinceEpoch.toString(),
                                                                examEndDate.millisecondsSinceEpoch.toString(),
