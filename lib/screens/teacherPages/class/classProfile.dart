                                ...
                                children: <Widget>[
                                  Expanded(
                                    child: InkWell(
                                      onTap: () {
                                        context.go(
                                            '/teacher/class/${academicCalendar.academicCalendarId}/student');
                                      },
                                      child: Container(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: InkWell(
                                      onTap: () {
                                        context.go(
                                            '/teacher/class/${academicCalendar.academicCalendarId}/attendance');
                                      },
                                      child: Container(
                                        padding: const EdgeInsets.all(10),
                                        width: double.maxFinite,
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                children: <Widget>[
                                                  ...
                                                  Text(
                                                    'Students details and registration.',
                                                    style: TextStyle(
                                                        color: Colors.grey[800],
                                                        fontSize: 15),
                                                  )
