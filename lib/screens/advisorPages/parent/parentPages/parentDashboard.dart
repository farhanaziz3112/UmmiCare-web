                                  ...
                                  child: Container(
                                    ...
                                    child: ElevatedButton.icon(
                                      ...
                                      onPressed: () {
                                        ...
                                        context.go('/advisor/parent/${id}/chat');
                                      },
                                      label: Row(
                                        children: [
                                          const SizedBox(
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: ElevatedButton.icon(
                                      ...
                                      onPressed: () {
                                        var id = parent.parentId;
                                        context.go('/advisor/parent/${id}/settings');
                                      },
                                      label: Row(
                                        children: [
                                          const SizedBox(
                                          ...
                                          const Flexible(
                                            child: Text(
                                              'System settings for advisory module. You can modify and change the settings according to your preferences.',
                                              style: TextStyle(
                                                  fontSize: 15.0,
                                                  color: Colors.white),
                                            ),
