...
import 'package:ummicare/screens/charts/noOfAllChildsOverallStatus.dart';
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasData) {
                        ...
                        return Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              const Expanded(child: noOfChildsCategory()),
                              Expanded(
                                  child: Column(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasData) {
                        ...
                        return Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              const Expanded(child: noOfAllChildsOverallStatus()),
                              Expanded(
                                  child: Column(
                                crossAxisAlignment: CrossAxisAlignment.center,
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: <Widget>[
                                  Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      const SizedBox(width: 5),
                                      Text(
                                        getNoOfChildStatus(childList!, 'great').toString(),
                                        style: const TextStyle(
                                            fontSize: 20,
                                            fontWeight: FontWeight.bold,
                                            color: Colors.black),
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      const SizedBox(width: 5),
                                      Text(getNoOfChildStatus(childList, 'normal').toString(),
                                        style: const TextStyle(
                                            fontSize: 20,
                                            fontWeight: FontWeight.bold,
                                            color: Colors.black),
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      const SizedBox(width: 5),
                                      Text(getNoOfChildStatus(childList, 'needs attention')
                                            .toString(),
                                        style: const TextStyle(
                                            fontSize: 20,
                                            fontWeight: FontWeight.bold,
