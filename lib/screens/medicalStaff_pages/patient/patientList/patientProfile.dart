                              ...
                              child: Center(
                                child: ElevatedButton.icon(
                                  ...
                                  onPressed: () {
                                    ...
                                    context.go(
                                        '/medicalstaff/patient/${id}/healthcondition');
                                  },
                                  label: const Row(
                              ...
                              child: Center(
                                child: ElevatedButton.icon(
                                  ...
                                  onPressed: () {
                                    var id = patient.patientId;
                                    context.go(
                                        '/medicalstaff/patient/${id}/physicalcondition');
                                  },
                                  label: const Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                              ...
                              child: Center(
                                child: ElevatedButton.icon(
                                  ...
                                  onPressed: () {
                                    var id = patient.patientId;
                                    context.go(
                                        '/medicalstaff/patient/${id}/chroniccondition');
                                  },
                                  label: const Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                              ...
                              child: Column(
                                children: <Widget>[
                                  SizedBox(
                                      height: 200,
                                      child:
                                          childBmi(healthId: patient.healthId)),
                                ],
                              ),
                            ),
                          ),
