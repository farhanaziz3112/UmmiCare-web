...
import '../../../../models/staffUserModel.dart';

class rejectedApplicationPage extends StatefulWidget {
  const rejectedApplicationPage({super.key, required this.staffId});
  final String staffId;

  @override
  State<rejectedApplicationPage> createState() => _rejectedApplicationPageState();
}
