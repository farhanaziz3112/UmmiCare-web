...
class verifiedTeacherProfile extends StatefulWidget {
  const verifiedTeacherProfile({super.key, required this.staffId});
  final String staffId;

  @override
  State<verifiedTeacherProfile> createState() => _verifiedTeacherProfileState();
}

class _verifiedTeacherProfileState extends State<verifiedTeacherProfile> {
  @override
