...
class rejectedMedicalStaff extends StatefulWidget {
  const rejectedMedicalStaff({super.key});

  @override
  State<rejectedMedicalStaff> createState() => _rejectedMedicalStaffState();
}

class _rejectedMedicalStaffState extends State<rejectedMedicalStaff> {
  @override
      ...
      child: Container(
          ...
          child: Column(children: <Widget>[
            ...
            Container(
              alignment: Alignment.centerLeft,
              child: const Text(
                'All the medical staff application that has been rejected by the administrator.',
                style: TextStyle(
                    color: Colors.grey,
                    fontSize: 15.0,
                    fontWeight: FontWeight.w500),
