...
class verifiedMedicalStaffProfile extends StatefulWidget {
  const verifiedMedicalStaffProfile({super.key, required this.staffId});
  final String staffId;

  @override
  State<verifiedMedicalStaffProfile> createState() =>
      _verifiedMedicalStaffProfileState();
}

class _verifiedMedicalStaffProfileState
    extends State<verifiedMedicalStaffProfile> {
  @override
