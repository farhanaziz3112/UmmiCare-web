...
class verifiedStaffProfilePage extends StatefulWidget {
  const verifiedStaffProfilePage({super.key, required this.staffId});
  final String staffId;

  @override
  State<verifiedStaffProfilePage> createState() =>
      _verifiedStaffProfilePageState();
}

class _verifiedStaffProfilePageState extends State<verifiedStaffProfilePage> {
  @override
