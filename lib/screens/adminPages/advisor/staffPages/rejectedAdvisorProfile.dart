...
class rejectedAdvisorProfile extends StatefulWidget {
  const rejectedAdvisorProfile({super.key, required this.staffId});
  final String staffId;

  @override
  State<rejectedAdvisorProfile> createState() => _rejectedAdvisorProfileState();
}

class _rejectedAdvisorProfileState extends State<rejectedAdvisorProfile> {
  @override
